...
`npm run verify` runs a full test suite (123 tests covering every gate, the idea gate's statistics,
and the ledger's cryptography) plus an adversarial release audit that fires 18 realistic attacks —
